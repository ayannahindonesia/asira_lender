...
type (
	Borrower struct {
		...
		Gender               string        `json:"gender" gorm:"column:gender;type:varchar(1);not_null" csv:"gender"`
		IdCardNumber         string        `json:"idcard_number" gorm:"column:idcard_number;type:varchar(255)" csv:"idcard_number"`
		...
		Email                string        `json:"email" gorm:"column:email;type:varchar(255)" csv:"email"`
		Birthday             time.Time     `json:"birthday" gorm:"column:birthday" csv:"birthday"`
		Birthplace           string        `json:"birthplace" gorm:"column:birthplace;type:varchar(255)" csv:"birthplace"`
		LastEducation        string        `json:"last_education" gorm:"column:last_education;type:varchar(255)" csv:"last_education"`
		MotherName           string        `json:"mother_name" gorm:"column:mother_name;type:varchar(255)" csv:"mother_name"`
		Phone                string        `json:"phone" gorm:"column:phone;type:varchar(255)" csv:"phone"`
		MarriedStatus        string        `json:"marriage_status" gorm:"column:marriage_status;type:varchar(255)" csv:"marriage_status"`
